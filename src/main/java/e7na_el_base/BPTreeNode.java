...
public abstract class BPTreeNode<T extends Comparable<T>> implements Serializable {
	...
	public BPTreeNode(int order, String SortingKey, String TableName) {
...
public int IndexInNode(T key) {
	 ...
	 */
	public abstract PushUp<T> insert(T key, Ref recordReference, BPTreeInnerNode<T> parent, int ptr,BPTree tree);
	 ...
	 */
	public abstract boolean delete(T key, BPTreeInnerNode<T> parent, int ptr, Ref refOfkey);
...
//	}
//
//	public BPTreeNode desNode(String filename) {
//		try {
//			FileInputStream fileIn = new FileInputStream(filename);
//			ObjectInputStream in = new ObjectInputStream(fileIn);
//			BPTreeNode<T> N = (BPTreeNode<T>) in.readObject();
//			in.close();
//			fileIn.close();
//			return N;
//		} catch (IOException i) {
